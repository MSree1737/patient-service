...
public class BillingServiceGrpcClient {
    ...
    public BillingServiceGrpcClient(
        ...
        log.info("<=> Pink Rose <=>Connecting to billing service...GRPC <=====> {}:{}", serviceAddress, servicePort);
        ManagedChannel channel = ManagedChannelBuilder.forAddress(serviceAddress,
